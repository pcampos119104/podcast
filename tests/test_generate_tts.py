...
def test_inference_command_passes_nova_reference_and_generation_options() -> None:
    nova_reference = PROJECT_ROOT / "assets" / "voices" / "nova_reference.wav"
...
def test_weekly_title_uses_previous_sunday() -> None:
    assert weekly_title(datetime(2026, 8, 26)) == "Podcast da semana do dia 23 de agosto"
